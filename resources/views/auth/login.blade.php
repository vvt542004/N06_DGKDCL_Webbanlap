...
@section('content')
    ...
    <div class="container mb-5 mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary-custom text-white font-weight-bold">{{ __('Đăng nhập EgaGear') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Nhập email">
                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button type="submit" class="btn text-white bg-primary-custom">
                                        {{ __('Đăng nhập') }}
                                    </button>
                                    ...
                                    @if (Route::has('register'))
                                        <a class="btn btn-link-custom" href="{{ route('register') }}">
                                            {{ __('Đăng ký') }}
                                        </a>
                                    @endif
                                </div>
